...
import { IAuthGoogle } from "./auth-google.interface";

export const AuthGoogle = ({text, route}: IAuthGoogle) => (
    <div className="w-full" onClick={() => signIn("google", { callbackUrl: route })}>
        <div className="border rounded-[0.5rem] w-full inline-flex items-center justify-center gap-3 py-3 px-6 hover:bg-gray-100 cursor-pointer">
