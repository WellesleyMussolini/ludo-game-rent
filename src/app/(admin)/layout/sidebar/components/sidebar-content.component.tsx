        ...
        <ul className="flex flex-col h-full px-3 py-2">
            {
                sidebarContent.map((sidebarItem, index) => (
                    <li key={index} onClick={() => handleSwitchRoute(sidebarItem.route)}
                        className={`
                            relative
                            flex
                            items-center
                            ...
                            transition-colors
                            group
                            ${sidebarItem.active ? "bg-gradient-to-tr from-green-200 to-green-100 text-green-800" : "hover:bg-green-50 text-gray-600"}
                            ${!expandedSidebar && "group-hover:bg-green-50 group-hover:text-gray-600"}
                        `}>
                        {sidebarItem.icon}
