...
export const BoardGameFormStepSaveId = ({ isLoading, writeGameId, handleOnChangeFields, handleCloseForm, handleNextStep }: IBoardGameFormStepSaveId) => <>
    <ActionButtonForm positionX="right-2" onClickIcon={handleCloseForm}>{<IoMdClose size={25} />}</ActionButtonForm>
    <div className="w-full px-10">
        <PrimaryInput style={EnumPrimaryInputStyle.SECONDARY} text="Insira o ID" htmlFor="id" id="id" handleOnChange={(event) => handleOnChangeFields("id", event)} type={EnumPrimaryInputType.NUMBER} />
    </div>
    <div className="w-full px-10">
